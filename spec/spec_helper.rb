...
module WorkdirHelper
  ...
  # `docnumber` carries the same string in the real corpus, and is included so a
  # fixture cannot accidentally pass by way of the wrong field.
  def doc(id, others = [])
    { "docnumber" => id,
      "docidentifier" => others + [{ "content" => id, "type" => "ETSI", "primary" => true }] }
  end
end
